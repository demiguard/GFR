...
# Note: This is leftover for some bad design.
# Mainly GFR depend on a couple of services, These programs are independant on the django
# These are the FetcherThread and SCPServer
